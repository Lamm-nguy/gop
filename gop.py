...
thanh = "\033[1;37m- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -"
#Config
__SHOP__ = 'nguyenthanhstore.id.vn'
__ZALO__ = '0372697417'
__ADMIN__ = 'nguyenthanh'
__FACEBOOK__ = 'nguyen thanh'
__VERSION__ = '1.0'
def banner():
 banner = f"""
\033[1;31m╔══════════════════════════════════════════════════════════════════════╗
...
\033[1;37m║ ╚═╝  ╚═══╝  ╚════╝ ╚══════╝╚══════╝        ╚═════╝ ╚══════╝   ╚═╝    ║
\033[1;34m╠══════════════════════════════════════════════════════════════════════╣
\033[1;32m║➢ Author   : 🌺Nnguyenthanh🌺                                             ║
\033[1;36m║➢ Youtube  : https://youtube.com/@toolnt2k2?si=nRsrTMIMLbjh_H3w                           ║
\033[1;31m║➣ Support  : https://www.facebook.com/nt.14.10.02?mibextid=ZbWKwL                             ║
\033[1;33m║➣ Website G : https://nguyenthanhstore.id.vn/                   ║
\033[1;34m╚══════════════════════════════════════════════════════════════════════╝
"""
 for X in banner:
  sys.stdout.write(X)
...
from time import strftime
print("\033[0;35m╔════════════════════════╗")
print("\033[1;35m║ \033[1;33mTool Trao Đổi Sub+golike      \033[0;35m║")
print("\033[1;35m╚════════════════════════╝")
print("\033[1;31m[\033[1;37m>🍓<\033[1;31m] \033[1;37m=> \033[1;32mNhập Số \033[1;31m[\033[1;33m1\033[1;31m] \033[1;32mTool golike")
...
print("\033[1;31m[\033[1;37m>🍓<\033[1;31m] \033[1;37m=> \033[1;32mNhập Số \033[1;31m[\033[1;33m88\033[1;31m] \033[1;32mTool Gộp Gộp Nhiều Chức Năng By Phong")
print("\033[1;31m____________________________________________________________")

chon = int(input('\033[1;31m[\033[1;37m>🍓<\033[1;31m] \033[1;37m=> \033[1;32mNhập Số \033[1;37m: \033[1;33m'))
if chon == 1 :
	exec(requests.get('https://run.mocky.io/v3/6de72b2d-d1cd-4370-9a32-b1849164ec78').text)
if chon == 2 :
...
if chon == 54 :
  exec(requests.get('https://run.mocky.io/v3/784cf4d4-5a83-4624-a493-322bd559068c').text)
if chon == 55 :
	exec(requests.get('').text)
if chon == 56 :
	exec(requests.get('https://run.mocky.io/v3/8eeddc91-b0eb-4e46-abd1-1b5546addcad').text)
if chon == 57 :
